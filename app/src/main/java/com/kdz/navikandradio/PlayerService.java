...
public class PlayerService extends IntentService implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener {
    ...
    public static final String ACTION_FIRST_PLAY = "com.apps.navikandradio.action.ACTION_FIRST";
    public static final String ACTION_SEEKTO = "com.apps.navikandradio.action.ACTION_SEEKTO";
    public static final String ACTION_PLAY = "com.apps.navikandradio.action.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.apps.navikandradio.action.PAUSE";
    public static final String ACTION_STOP = "com.apps.navikandradio.action.STOP";
    ...
    public void onCreate() {
        ...
        Constant.exoPlayer = ExoPlayerFactory.newSimpleInstance(Constant.context, trackSelector);
...
// Produces DataSource instances through which media data is loaded.
                DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(Constant.context,
                        Util.getUserAgent(Constant.context, "navikandradio"), bandwidthMeter);
...
//        startForeground(101, notification.build());
    ...
    private void changeEquilizer() {
        ...
        } else if(Constant.frag.equals("download")) {
