...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void addToFav(ItemSong itemSong) {
        ...
        String insert = "insert into song (sid,title,desc,artist,duration,url,image,image_small,cid,cname) values ('" + itemSong.getId() + "', '" + name + "', " + a + ", '" +itemSong.getArtist() + "', '" + itemSong.getDuration() + "', '" + itemSong.getMp3Url() + "', '" + itemSong.getImageBig() + "', '" + itemSong.getImageSmall() + "', '" + itemSong.getCategoryId() + "', '" + cat_name + "')";
        dml(insert);
    }
    ...
    public void addToRecent(ItemSong itemSong) {
        ...
        String name = itemSong.getMp3Name().replace("'","%27");
        String cat_name = itemSong.getCategoryName().replace("'","%27");
        String insert = "insert into recent (sid,title,desc,artist,duration,url,image,image_small,cid,cname) values ('" + itemSong.getId() + "', '" + name + "', " + a + ", '" + itemSong.getArtist() + "', '" + itemSong.getDuration() + "', '" + itemSong.getMp3Url() + "', '" + itemSong.getImageBig() + "', '" + itemSong.getImageSmall() + "', '" + itemSong.getCategoryId() + "', '" + cat_name + "')";
        dml(insert);
    }
    ...
    public ArrayList<ItemSong> loadData() {
        ...
        if(cursor!=null && cursor.getCount() > 0) {
            ...
            for(int i=0; i<cursor.getCount();i++) {
                ...
                ItemSong objItem = new ItemSong(id,cid,cname,artist,url,imagebig,imagesmall,name,duration,desc);
